from data.engie_dataset import ENGIEDataset
from exp.exp_basic import Exp_Basic
from models.HSTTN.model import HSTTN
from utils.tools import EarlyStopping, adjust_learning_rate
from utils.metrics_engie import regressor_detailed_scores, all_turb_multi_interval_scores, show_metric_scores
...
class Exp_engie_HSTTN(Exp_Basic):
    def __init__(self, args):
        super(Exp_engie_HSTTN, self).__init__(args)
        self._get_data()
