...
from exp.exp_kddcup_HSTTN import Exp_kddcup_HSTTN
...
parser.add_argument('--data', type=str, required=True, default='KDDCUP', help='data')
#parser.add_argument('--root_path', type=str, default='./data/ETT/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='/data/KDDCUP/')
...
parser.add_argument('--train_days', type=int, default=155, help='Number of days for training')
parser.add_argument('--val_days', type=int, default=30, help='Number of days for validation')
parser.add_argument('--test_days', type=int, default=60, help='Number of days for testing')
parser.add_argument('--total_days', type=int, default=245, help='Number of days for the whole dataset')
parser.add_argument('--Turbins', type=int, default=134, help="The number of wind turbines in a wind farm")
...
parser.add_argument('--max_grad_norm', type=float, default=0, help='0: not use')
